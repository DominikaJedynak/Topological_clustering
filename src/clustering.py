...
class HierarchicalClustering(Clustering):
    def fit(self, trajectories, metric, *params):
        """
        :param trajectories: list of trajectories (consisting of symbols)
        :param t:
        """
...
class CombinatorialHierarchicalClustering(HierarchicalClustering):
    def fit(self, trajectories, *params):
        ...
        return super().fit(trajectories, combinatorial_distance, params[0])
...
class DTWHierarchicalClustering(HierarchicalClustering):
    def fit(self, trajectories, *params):
        ...
        return super().fit(trajectories, DTW_distance, params[0])
